...
export const HOME_ENTRIES = [
  {
    id: "concepts",
    icon: "🧩",
    titleKey: "entry.concepts.t",
    descKey: "entry.concepts.d",
  },
  {
    id: "glossary",
    icon: "📖",
    titleKey: "entry.glossary.t",
    descKey: "entry.glossary.d",
  },
  {
    id: "psychologists",
    icon: "🧠",
    titleKey: "entry.psychologists.t",
    descKey: "entry.psychologists.d",
  },
  {
    id: "schools",
    icon: "🏛️",
    titleKey: "entry.schools.t",
    descKey: "entry.schools.d",
  },
  {
    id: "biases",
    icon: "🎭",
    titleKey: "entry.biases.t",
    descKey: "entry.biases.d",
  },
  {
    id: "experiments",
    icon: "🔬",
    titleKey: "entry.experiments.t",
    descKey: "entry.experiments.d",
  },
  {
    id: "timeline",
    icon: "🗓️",
    titleKey: "entry.timeline.t",
    descKey: "entry.timeline.d",
  },
  {
    id: "everyday",
    icon: "🌆",
    titleKey: "entry.everyday.t",
    descKey: "entry.everyday.d",
  },
  {
    id: "myths",
    icon: "💡",
    titleKey: "entry.myths.t",
    descKey: "entry.myths.d",
  },
  { id: "quiz", icon: "✅", titleKey: "entry.quiz.t", descKey: "entry.quiz.d" },
  {
    id: "compare",
    icon: "🌐",
    titleKey: "entry.compare.t",
    descKey: "entry.compare.d",
  },
  {
    id: "demos",
    icon: "🎮",
    titleKey: "entry.demos.t",
    descKey: "entry.demos.d",
  },
  {
    id: "bigfive",
    icon: "📊",
    titleKey: "entry.bigfive.t",
    descKey: "entry.bigfive.d",
  },
  {
    id: "selfrating",
    icon: "🧪",
    titleKey: "entry.selfrating.t",
    descKey: "entry.selfrating.d",
  },
];
...
export async function readJson(name) {
  return JSON.parse(
    await readFile(
      join(DATA, name.endsWith(".json") ? name : name + ".json"),
      "utf8",
    ),
  );
}
